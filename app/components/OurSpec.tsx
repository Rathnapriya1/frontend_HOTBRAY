...
import { ourSpecsData } from "@/asset/asset";
...
const OurSpecs = () => {
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      ...
      <p className="text-center text-black text-slate-600  gap-5 mb-10">
        ...
        Shop with confidence knowing you’re getting parts built to last.
      </p>
        ...
        {ourSpecsData.map((spec, index) => {
          return (
            <div
              ...
              key={index}
            >
              <h3 className="text-slate-800 font-semibold font-medium">{spec.title}</h3>
              <p className="text-sm text-slate-600 text-black mt-3">{spec.description}</p>
