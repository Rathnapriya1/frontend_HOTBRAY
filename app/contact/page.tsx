...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-gray-50 pb-16 text-black">
      {/* Banner Section */}
      <section className="relative w-full h-[400px] md:h-[450px] bg-black">
        <Image
          src="https://di-uploads-pod7.dealerinspire.com/jaguaromaha/uploads/2022/08/2023-jaguar-f-pace-in-portfino-blue-banner-1440x450.jpg"
      ...
      <section className="py-16 px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 text-center">
          ...
          >
            ...
            <p className="text-white mt-2">rathnapriya@dgstechlimited.com</p>
          </a>
